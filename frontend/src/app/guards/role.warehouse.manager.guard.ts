...
export class RoleWarehouseManagerGuard implements CanActivate {
    constructor(
    ...
    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        const roles = [environment.roles.superAdmin, environment.roles.admin, environment.roles.warehouseManager];
