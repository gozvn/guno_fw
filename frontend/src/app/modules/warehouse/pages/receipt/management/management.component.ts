...
import {WarehousePageReceiptPartialCreateComponent} from "../_partials/create/create.component";
import {WarehousePageReceiptPartialDetailComponent} from "../_partials/detail/detail.component";
import {SupplierService} from "../../../services/supplier.service";

@Component({
    selector: 'app-warehouse-page-receipt-management',
    templateUrl: './management.component.html',
    styleUrl: './management.component.scss'
})
export class WarehousePageReceiptManagementComponent extends BaseComponent implements OnDestroy {
    selectedTabIndex = 0;
    ...
    displayedColumns: string[] = [
        'id', 'createdBy', 'warehouse', 'note', 'supplier', 'type', 'totalQuantity', 'updatedAt', 'status'
    ];
    ...
    search(loadingState = true) {
        ...
        this.inventoryReceiptService.search(params).subscribe((result: any) => {
    ...
    openDialogCreateReceipt() {
        const dialogRef = this.dialog.open(WarehousePageReceiptPartialCreateComponent, {
            autoFocus: true,
            width: '95vw',
            height: 'auto',
            panelClass: 'warehouse-dialog-receipt-create',
