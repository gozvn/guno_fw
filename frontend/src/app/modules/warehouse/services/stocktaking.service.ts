...
export class StocktakingService {
    ...
    create(data: any) {
        const path = this.apiServerPaths.gunoHub.warehouse.stocktaking.create;
        const body: any = data;
    ...
    search(params: any) {
        const path = this.apiServerPaths.gunoHub.warehouse.stocktaking.search;
        const options: any = {
            params: {
                encryptParam: true
            },
    ...
    getItemByNumber(stocktakingNumber: number) {
        const path = this.apiServerPaths.gunoHub.warehouse.stocktaking.detail.replace('{NUMBER}', stocktakingNumber.toString());
        const options: any = {
            params: {
                encryptParam: true
            },
