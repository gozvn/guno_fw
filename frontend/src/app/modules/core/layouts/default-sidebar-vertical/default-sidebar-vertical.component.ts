...
@Component({
    ...
    templateUrl: './default-sidebar-vertical.component.html',
    styleUrl: './default-sidebar-vertical.component.scss',
    encapsulation: ViewEncapsulation.None
})
export class LayoutDefaultSidebarVerticalComponent extends BaseComponent implements OnDestroy, AfterViewInit {
