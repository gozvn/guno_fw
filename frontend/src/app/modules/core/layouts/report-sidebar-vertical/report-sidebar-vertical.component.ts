...
import {sidenavReportItems} from '../_partials/vertical/sidebar/sidebar-reports-data';
import {AppBrandingComponent} from "../_partials/app-branding/app-branding.component";
...
@Component({
    ...
    templateUrl: './report-sidebar-vertical.component.html',
    styleUrl: './report-sidebar-vertical.component.scss',
    encapsulation: ViewEncapsulation.None
})
export class LayoutReportSidebarVerticalComponent extends BaseComponent implements OnDestroy, AfterViewInit {

    private htmlElement!: HTMLHtmlElement;
    navItems = navItems;

    sidenavItems = sidenavReportItems;
